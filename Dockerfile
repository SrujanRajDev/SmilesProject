...
RUN wget http://13.232.21.231:8081/nexus/content/repositories/myapp-releases/com/edurekademo/tutorial/addressbook/3.0/addressbook-3.0.war
RUN cp addressbook-3.0.war /usr/local/tomcat/webapps/
